...
namespace Services
{
    public class AuthenticationManager : IAuthenticationService
    {
        ...
        public async Task<TokenDto> CreateToken(bool populateExp)
        {
            ...
            var tokenOptions = GenereTokenOptions(signinCredentials, claims);
        ...
        private JwtSecurityToken GenereTokenOptions(SigningCredentials signinCredentials, List<Claim> claims)
        {
            var jwtSettings = _configuration.GetSection("JwtSettings");
            //var key = Encoding.UTF8.GetBytes(jwtSettings["secretKey"]);
        ...
        public async Task<TokenDto> RefreshToken(TokenDto tokenDto)
        {
            ...
            {
                throw RefreshTokenBadRequestException();
            }
        ...
        private Exception RefreshTokenBadRequestException()
        {
